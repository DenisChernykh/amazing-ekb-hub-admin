...
| `IMPORT_RUN_UPDATED_EVENT`                       | `src/entities/import-run/model/import-run-events.ts` | exported   | Defines the backend SSE event name carrying successful import run updates.                                      |
