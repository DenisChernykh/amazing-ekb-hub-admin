...
| Admin create place               | Есть; `summary`/`tags` optional in backend PR [#41](https://github.com/DenisChernykh/amazing-ekb-hub-backend/pull/41), closing [backend issue #26](https://github.com/DenisChernykh/amazing-ekb-hub-backend/issues/26)                                                                                 | Не требуется                                                                                                                                | Есть: route `/places/new`, AntD create form, validation feedback; branch `codex/optional-place-fields-admin-sync` removes required UI validation for `summary`/`tags` under admin issue [#5](https://github.com/DenisChernykh/amazing-ekb-hub-admin/issues/5) | Нужен runtime smoke с реальным backend                   |
...
- Status: create, edit, status, and cover upload slices are done in admin `main`; edit form landed via merged admin PR [#4](https://github.com/DenisChernykh/amazing-ekb-hub-admin/pull/4), cover upload landed via merged admin PR [#6](https://github.com/DenisChernykh/amazing-ekb-hub-admin/pull/6). Backend PR [#41](https://github.com/DenisChernykh/amazing-ekb-hub-backend/pull/41) made `summary` and `tags` optional; branch `codex/optional-place-fields-admin-sync` implements the admin UI follow-up from [admin issue #5](https://github.com/DenisChernykh/amazing-ekb-hub-admin/issues/5).
