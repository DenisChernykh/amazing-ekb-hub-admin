...
| Admin bulk moderation            | Есть одиночный `PATCH /admin/places/{placeId}/status`; backend bulk endpoint не нужен для первого frontend-heavy среза                                                                                                                                                                                                                 | Не требуется                                                                                                                                | In progress: client-side bulk status workflow over existing single-place endpoint; tracked in [admin issue #15](https://github.com/DenisChernykh/amazing-ekb-hub-admin/issues/15) and [Notion roadmap](https://www.notion.so/356756c470b381a2837cf46bfd122dc6). Future draft-selection persistence is tracked separately in [admin issue #20](https://github.com/DenisChernykh/amazing-ekb-hub-admin/issues/20). | Нужны final verification, PR/merge, and runtime smoke    |
...
- Status: in progress; tracked in admin issue [#15](https://github.com/DenisChernykh/amazing-ekb-hub-admin/issues/15) and [Notion roadmap](https://www.notion.so/356756c470b381a2837cf46bfd122dc6). This is an intentional Learning / Frontend architecture slice for Redux Toolkit.
