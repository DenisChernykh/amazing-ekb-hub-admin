...
6. Должно ли избранное быть частью публичного MVP сейчас или остается optional?
7. Нужна ли отдельная роль editor/moderator позже, или `admin/user` достаточно для ближайших фаз?
8. Должна ли админка иметь operational health page, или health endpoints остаются только для инфраструктуры?
