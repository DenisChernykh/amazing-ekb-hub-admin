...
export const MaterialsRedirect302Response = zod.unknown()

export const materialsRedirect404ResponseStatusMin = 400
export const materialsRedirect404ResponseStatusMax = 599

export const MaterialsRedirect404Response = zod.strictObject({
  code: zod.enum([
  ...
  status: zod
    .number()
    .min(materialsRedirect404ResponseStatusMin)
    .max(materialsRedirect404ResponseStatusMax),
  title: zod.string(),
  type: zod.url(),
})

export const materialsRedirect500ResponseStatusMin = 400
export const materialsRedirect500ResponseStatusMax = 599

export const MaterialsRedirect500Response = zod.strictObject({
  code: zod.enum([
    'ACTIVE_IMPORT_EXISTS',
    'AUTHENTICATION_REQUIRED',
    'AUTHORIZATION_DENIED',
  ...
  status: zod
    .number()
    .min(materialsRedirect500ResponseStatusMin)
    .max(materialsRedirect500ResponseStatusMax),
  title: zod.string(),
  type: zod.url(),
})
